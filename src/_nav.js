...
const _nav = [
  {
    ...
    icon: (
      <img
        src="https://minio-api.tienhoangdev.com/public-assets/images/programming.png"
  ...
  },
  {
    ...
    icon: (
      <img
        src="/programming-basics-logo.png"
        style={{ width: '2rem', marginRight: '1rem' }}
        alt="nav-icon"
      />
    ),
  ...
  },
  {
    ...
    items: [
      {
        component: CNavItem,
        name: 'Sheet trả lời trắc nghiệm',
        to: '/linhtinh/multi-choice-answer-sheet',
      },
    ],
  },
  {
